...
module.exports = function(RED) {
    ...
    function TemplateReport(n) {
        RED.nodes.createNode(this,n);
        this.name = n.name;
        this.field = n.field || "payload";
        this.template = n.template;
        this.syntax = n.syntax || "mustache"; //"plain"
        this.fieldType = n.fieldType || "msg"; //['msg', 'flow', 'global']
        this.outputFormat = n.output || "str"; //"json" // "yaml"
    ...
    RED.nodes.registerType("rp.template",TemplateReport);
