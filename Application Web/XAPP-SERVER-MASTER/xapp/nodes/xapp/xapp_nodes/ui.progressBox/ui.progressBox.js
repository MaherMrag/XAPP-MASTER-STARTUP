...
module.exports = function (RED) {
    ...
    RED.nodes.registerType("ui.progressBox", ProgressBox);
        ...
        getData: function (req, res) {
            ...
            for (var id in node.payload) {
                if (node.payload.hasOwnProperty(id)) {
                    ...
                    promises.push(progressBox.findData(nn, date))
                }
            }
    ...
    RED.httpAdmin.post("/progressBox/:id", progressBox.getData);
