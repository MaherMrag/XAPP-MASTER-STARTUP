...
module.exports = function (RED) {
    ...
    function CalculatorNode(config) {
        ...
        /* node.CalculInterval = setInterval(cyclicCalcul, 5000); */

        function cyclicCalcul() {
        ...
        function findData(nn, date) {
            return new Promise(function (resolve, reject) {
                setTimeout(() => nn.aggregate(date, "sum", (data) => {
                    resolve(data);
                }), 200);
            })
        };
        ...
        function getData() {
            ...
            var date = {
                startDate: '2020-05-01T23:00:00.000Z',
                endDate: '2020-05-09T22:59:59.999Z'
            };
            ...
            for (var id in node.payload) {
                if (node.payload.hasOwnProperty(id)) {
                    ...
                    promises.push(findData(nn, date))
                }
            }
            ...
            when.settle(promises).then(function (result) {
                result.forEach(function (res) {
                    ...
                    console.log('Rsult : ',res.value.result);
                })
    ...
    RED.nodes.registerType("s7.calculator", CalculatorNode);
}
